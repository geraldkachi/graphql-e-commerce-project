...
// this way or this way the container is still passed  dont want to dhange code so i used { default as  CollectionsOverview}
...
const ShopPage = ({ match }) => (
  <div className='shop-page'>
    <Route exact path={`${match.path}`} component={CollectionsOverviewContainerGql} />
    <Route path={`${match.path}/:collectionId`} component={CollectionPageContainerGql} />
  </div>  
);
